  ...
  return (
    <section className="py-16 px-4 md:px-12 max-w-5xl mx-auto text-left">
      ...
      <p className="text-[var(--gray-500)] text-lg leading-relaxed mb-4">
        The LBX token is more than just an asset — it represents direct participation in the fund. 
      ...
      <ul className="list-disc list-inside space-y-3 text-[var(--gray-500)] text-lg leading-relaxed">
        <li>
          ...
          Vote on strategic decisions through the dashboard. Your voice helps shape the fund's direction.
        </li>
        <li>
          <span className="font-semibold text-[var(--gray-200)]">Real Yield Backing:</span> 
          Token appreciation is driven by real profits, not hype. Weekly dividends increase the token’s value over time.
        </li>
        <li>
          <span className="font-semibold text-[var(--gray-200)]">Controlled Inflation:</span> 
          New tokens are minted only when the fund has cash in hand — under strict management and community visibility.
        </li>
      </ul>
    </section>
  )
